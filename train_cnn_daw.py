...
for epoch in range(32):
    ...
    for question, positives, negatives in tqdm(load_cnn_dataset("train")):
        ...
        askubuntu_score = torch.mean(GradReverse()(classifier(negatives)))
        ...
        android_score = torch.mean(GradReverse()(classifier(negg)))

        loss = (android_score - askubuntu_score) * args.classifier_weight
        if loss.data[0] > -1.0:
